		...
		else if (names.length >= 10) //10 + is way too much!
		{
			...
			$.ajax({
				...
				success: function (res) {
					...
					$('#result').html('<a target="_blank" class="btn btn-warning" href="' + res.created + '">Download GIF</a> <div class="result-image"><img height=150 class="img-responsive" src="' + res.created + '" /> </div>');
